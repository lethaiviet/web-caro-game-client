...
export interface SocketServerEvents {
  ...
  "chat:response:get-all-private-messages-in-room": (
...
export interface SocketClientEvents {
  ...
  "chat:acknowledgement:get-all-users-status": (
    callback: (data: UserStates[]) => void
  ) => void;
  "chat:acknowledgement:get-all-private-messages-in-all-rooms": (
    callback: (allMessages: AllMessagesInRoom[]) => void
  ) => void;
